...
if (isset($_POST['email'])){
    ...
    if($rows==1){
        ...
        header("Location: BusinessLayer/UserMainPage.php"); // Redirect user to index.php

    }else{
        echo "<div class='form'><h3>Username/password is incorrect.</h3><br/>Click here to <a href='../BusinessLayer/index.php'>Login</a></div>";
    }
}else{}
?>
...
<div class="login-extra">
    Don't you have an account? <a href="BusinessLayer/SignUp.php">
        <div>
...
<div class="login-extra">
    For Admin Panel! <a href="BusinessLayer/LoginAdmin.php">
        <div>
            Login Admin
        </div>
    </a>
